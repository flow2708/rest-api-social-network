...
public class LoginServlet extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        out.println("        }");
        out.println("        .login-form label {");
        out.println("            color: #fff;");
        out.println("            font-size: 2.3em;");
        out.println("            margin-bottom: 30px;");
        out.println("            font-weight: bold;");
        out.println("        }");
        out.println("        .login-form input {");
        ...
        out.println("        }");
        out.println("        .login-form button:hover {");
        ...
        out.println("        }");
        out.println("        .register-link:hover {");
        ...
        out.println("        <form class=\"login-form\" action='login' method='POST' xmlns:th='http://www.w3.org/1999/xhtml'>");
        out.println("            <label>Вход</label>");
        ...
        out.println("            <a href='register' class=\"register-link\">Регистрация</a>");
        out.println("        </form>");
        out.println("    </div>");
        out.println("</body>");
        out.println("</html>");
